...
<body>
    ...
    <div id="a">
        <div id="b">
            <img  id="i11" alt="set  reminder" src="reminderr.png" class="center"></img>
        </div>
        <div id="c">
            <span id="c">----- Set Reminder -----
            </span>
            <!--<hr size="0">-->
        </div>
        <div id="d">
            ...
            <form>
                ...
                <input type="number" class="text1" placeholder="Enter Qty" ; size="25" maxlength="30">
                
                <div id="lock">
                    <img src="price.png" id="i3">
                </div>
                <input type="number" class="text2" placeholder="Enter Price" ; size="25" maxlength="30">
                
                <div id="lock">
                    <img src="reminder.png" id="i3">
                </div>
                <input type="number" class="text2" placeholder="Enter Qty limit" ; size="25" maxlength="30">
                
                <input type="submit" value="Set Reminder" id="s3" onclick="validate()"></div>
        </div>