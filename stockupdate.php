...
<body>
    ...
    <div id="a">
        ...
        <div id="d">
            ...
            <form action="http://topicaldesign.epizy.com/update1.php" method="post">

                <input type="text" class="text"  name="pname" placeholder="Enter Product Name" ; size="20" maxlength="30"></input>
                <br>
                ...
                <input type="number" class="text1" name="qty" placeholder="Sold Qty" ; size="25" maxlength="30">
                <input type="hidden" name="id"> 
              
                <br>
                <input type="submit" value="Update" id="s3"></div>
            </form>
        </div>